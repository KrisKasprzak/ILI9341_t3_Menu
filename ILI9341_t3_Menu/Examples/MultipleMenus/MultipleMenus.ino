...
#define MENU_TEXT           ILI9341_BLACK
#define MENU_DISABLE        0xC618
#define MENU_BACKGROUND     ILI9341_WHITE
#define MENU_HIGHLIGHTTEXT  ILI9341_BLACK
#define MENU_HIGHLIGHT      0xFDEE
#define MENU_SELECTTEXT     ILI9341_WHITE
#define MENU_SELECTBORDER   0xFD20
#define MENU_SELECT         ILI9341_RED
...
void setup() {
  ...
  */
  ...
  // setTitleTextMargins(LeftMargin, TopMargin);
  SensorMenu.setTitleTextMargins(60, 7);
  ...
  // setItemTextMargins(LeftMargin, TopMargin, MarginBetweenTitleBarAndMenu);
  SensorMenu.setItemTextMargins(7, 9, 10);
  ...
  WirelessOption12 = WirelessMenu.addNI("Broadband", 1, 0, sizeof(YesNoItems) / sizeof(YesNoItems[0]), 1, 0, YesNoItems);
  WirelessMenu.setItemTextMargins(6, 4, 5);
...
void loop() {
  ...
  Display.print(MenuItemText[MenuOption]);
  delay(500);
  Display.setCursor(10, 100);
  Display.setFont(FONT_TITLE);
...
void ProcessSensorMenu() {
  ...
  while (EditMenuOption > 0) {
    ...
    if (digitalRead(SE_PIN) == LOW) {
      ...
      if (EditMenuOption == SensorOption5) { // budget item
