/*
  ...
  4. example that uses buttons for input (up/down/enter)
...
// the second arguement is no longer needed as v3.0 of this libray supports touch and mechanical at the same time
...
void setup() {
  ...
  */
  ...
  ColorMenu.setTitleTextMargins(50, 7);
  ColorMenu.setItemTextMargins(2, 8, 5);
  ColorMenu.setMenuBarMargins(2, 318, 4, 2);
